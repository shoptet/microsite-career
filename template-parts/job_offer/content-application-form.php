  ...
  <div class="form-group">
    <div class="form-check">
      ...
      <label class="form-check-label" for="jobApplicationGDPR">
        Vložením svého jména, kontaktního e-mailu a CV souhlasím se <a href="https://www.shoptet.cz/podminky-ochrany-osobnich-udaju/" target="_blank">zpracováním osobních údajů</a> společností Shoptet, a.s. pro účely výběrového řízení.
      </label>
    </div>
  </div>
